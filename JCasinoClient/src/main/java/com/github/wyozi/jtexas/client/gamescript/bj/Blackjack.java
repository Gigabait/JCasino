...
import com.github.wyozi.jtexas.commons.net.games.BlackJackAction;
...
public class Blackjack extends Game implements ButtonActionListener, Multiplayable {
    ...
    public void handlePacket(int opcode, NetInputStream packet)
        ...
        if (opcode == HoldEmOpcodes.LEAVE_TABLE_SEAT) {
            ...
            final BjOtherPlayer player = new BjOtherPlayer(name, chips);
            ...
            final BjOtherPlayer player = getSeat(seat);
            ...
            final BjOtherPlayer zeat = getSeat(seat);
            if (zeat != null) {
        	...
        	setAct(seat, BlackJackAction.getAction(act));
